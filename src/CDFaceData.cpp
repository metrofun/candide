...
size_t CDFaceData::getIndexOfShapeUnit(const std::string& name) const
{
...
size_t CDFaceData::getIndexOfAnimationUnit(const std::string& name) const
{
...
float CDFaceData::getAnimationUnitValue(const std::string& auName) const
{
    size_t idx = getIndexOfAnimationUnit(auName);
    return animationUnitSettings.at(idx);
}

float CDFaceData::getShapeUnitValue(const std::string& suName) const
{
    size_t idx = getIndexOfShapeUnit(suName);
    return shapeUnitSettings.at(idx);
}
